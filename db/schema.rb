...
ActiveRecord::Schema.define(version: 20160513104250) do
  ...
  add_index "merchants", ["mondo_id"], name: "index_merchants_on_mondo_id", using: :btree
  ...
  add_index "transactions", ["mondo_id"], name: "index_transactions_on_mondo_id", using: :btree
  ...
  create_table "users", force: :cascade do |t|
    ...
    t.datetime "updated_at",                            null: false
    t.string   "categories"
    t.boolean  "allows_checkins",        default: true
  end
